...
//Updated by https://github.com/antijingoist to remove jQuery
//Modified by https://github.com/realdekkia for use in unroll.ninja
...
var MastodonAPI = function (config) {
    ...
    function onAjaxError(url, op, xhr, callback) {
    ...
    return {
        ...
        get: function (endpoint) {
            ...
            return ajax(
                ...
                function (xhr) { onAjaxError(url, "GET", xhr, callback); },
                queryData,
        ...
        patch: function (endpoint) {
            ...
            return ajax(
                ...
                function (xhr) { onAjaxError(url, "PATCH", xhr, callback); },
                patchData,
                addAuthorizationHeader({}, config.api_user_token),
        ...
        post: function (endpoint) {
            ...
            return ajax(
                ...
                function (xhr) { onAjaxError(url, "POST", xhr, callback); },
                postData,
                addAuthorizationHeader({}, config.api_user_token),
                { 'Content-Type': 'application/json' }
            );
        ...
        postMedia: function (endpoint) {
            ...
            return ajax(
                ...
                function (xhr) { onAjaxError(url, "POST MEDIA", xhr, callback); },
                formData,
                addAuthorizationHeader({}, config.api_user_token)
            );
        },
        delete: function (endpoint, callback) {
            ...
            return ajax(
                ...
                function (xhr) { onAjaxError(url, "DELETE", xhr, callback); },
                null,
                addAuthorizationHeader({}, config.api_user_token)
            );
        },
        ...
        registerApplication: function (client_name, redirect_uri, scopes, website, callback) {
            ...
            return ajax(
                ...
                function (xhr) { onAjaxError(url, "REGISTER", xhr, callback); },
                {
        ...
        getAccessTokenFromAuthCode: function (client_id, client_secret, redirect_uri, code, callback) {
            ...
            return ajax(
                ...
                function (xhr) { onAjaxError(url, "TOKEN", xhr, callback); },
                {
                    client_id: client_id,
